...
class GustoTalleress(models.Model):
    ...
    participantes_talleres_ids = fields.Many2many('res.partner', relation='gusto_talleres1_rel', string='PARTICIPANTES')
    participantes_talleres2_ids = fields.One2many('res.partner', 'talleres_id')
    gusto_id = fields.Many2one('res.partner', string='PARTICIPANTES') # Necesario para gusto
