# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/gustos_interesesprofesionales.xml',
        'views/gustos_productos.xml',
        'views/gustos_necesidadesformacionespecifica.xml',
        'views/gustos_objetivoprofesional.xml',
        'views/gustos_participantes.xml',
        'views/gustos_proyectos.xml',
        'views/gustos_programas.xml',
        'views/gustos_convocatorias.xml',
        'views/gustos_oportunidad.xml',
        'views/gustos_menu.xml',
