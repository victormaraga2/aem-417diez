...
class CaptacionCaptacion(models.Model):
    ...
    _description = 'Registro de captacion sto'
    ...
    #larma = fields.Boolean(string="AV.", default=False)   ##########       CAPTACION
    ...
    def create(self, vals):
        # Crea el registro
        record = super(CaptacionCaptacion, self).create(vals)
    ...
    def write(self, vals):
        ...
        result = super(CaptacionCaptacion, self).write(vals)
 ...
 #           record.talleres_captacion2_ids.unlink()
 #
...
#                    'captacion_id': record.id,  # Establecer la relación inversa
#                })
    ###############################################################
    ...
    def write(self, vals):
        ...
        if pasa:
            ...
            self.env['captacion.historico.sto'].create({
        ...
        return super(CaptacionCaptacion, self).write(vals)
    """
