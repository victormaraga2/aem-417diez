...
class CaptacionImportcsvTipocontratossWizard(models.TransientModel):
    _name = 'captacion.importcsv.tipocontratoss.wizard'
    ...
    def update_records(self):
        ...
        for row in reader:
            ...
            if record:
                ...
                record = self.env['captacion.tipo.contratoss'].create({
                    'name': name,
