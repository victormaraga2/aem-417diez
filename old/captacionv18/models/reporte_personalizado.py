...
class CaptacionReportePersonalizado(models.Model):
    _name = 'captacion.reporte.personalizado'
    _description = 'Captacion Reporte Personalizado'
    ...
    def imprimir_reporte(self):
        ...
        return self.env.ref('captacion.reporte_personalizado_pdf').report_action(self, data={'reporte': datos_reporte})
