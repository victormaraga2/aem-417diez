...
class CaptacionCaptacionSQL(models.Model):
    _name = 'captacion.captacion.sql'
    ...
    def init(self):
        ...
        tools.drop_view_if_exists(self._cr, 'captacion_captacion_sql')
        self._cr.execute("""
            CREATE OR REPLACE VIEW captacion_captacion_sql AS (
                SELECT
                    id AS id,
                    q_participante,
                    q_baja,
