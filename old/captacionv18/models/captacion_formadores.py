...
class CaptacionFormadores(models.Model):
    _name = 'captacion.formadores'
    ...
    acciones_formativas_ids = fields.One2many('captacion.acciones.formativas', 'formador_id', string="Acciones Formativas")
