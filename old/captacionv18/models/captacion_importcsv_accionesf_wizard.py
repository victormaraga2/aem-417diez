...
class CaptacionImportcsvAccionesfWizard(models.TransientModel):
    _name = 'captacion.importcsv.accionesf.wizard'
    ...
    def process_csv(self):
        ...
        for row in reader:
            ...
            record = self.env['captacion.acciones.formativas'].search([('name', '=', name.upper())], limit=1)
        ...
        return {
            ...
            'res_model': 'captacion.importcsv.accionesf.wizard',
            'view_mode': 'form',
            'res_id': self.id,
            'target': 'new',
        }
    ...
    def update_records(self):
        ...
        for row in reader:
            ...
            observacion = row[12]
            # Buscar si el registro ya existe en modelo_A
            record = self.env['captacion.acciones.formativas'].search([('name', '=', name)], limit=1)
